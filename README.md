...
> API 명세서 : [Swagger 바로가기](https://www.recipe.o-r.kr:8443/swagger-ui/index.html)<br>
...
<details>
  ...
  <ul>
    ...
    <p> - 로그아웃시 엑세스 토큰과 쿠키를 로그아웃시 만료</p>
  </ul>
</details>
...
<details>
  <summary>아이디/ 비밀번호 찾기</summary>
    <ul>
        ...
        <p> - 회원가입시 입력한 실명, 이메일을 통해 인증후 아이디를 반환합니다.</p><hr>
        <h3>비밀번호 찾기</h3>
        <img alt="비밀번호 찾기" height="500" src="https://github.com/user-attachments/assets/df4acf5b-1412-4c39-a70d-56f5358037e0" width="800"/>
        <p> - 회원가입시 입력한 실명, 로그인아이디, 이메일을통해 인증 후 해당 회원이 존재시 일정시간 쿠키 발급후 비밀번호 변경(변경시 쿠키삭제)</p><hr>
    </ul>
</details>
...
<details>
  ...
  <ul>
    ...
    <p> - 게시글 댓글, 좋아요 사용시 작성자에게 알림이 전송, 댓글, 좋아요 해제시 알림 내역 삭제</p>
    <hr>
    <h3>관리자 알림</h3>
    <p> - 관리자는 사용자가 문의사항등록시 관리자에게 문의사항 등록 알림 발송 됩니다.</p>
...
<details>
  ...
  <ul>
    ...
    <p> - 관리자는 사용자를 강제로 추방할수 있습니다. 추방시 가입한 이메일로 추방안내 메일이 발송되게 되며, 추후 해당 이메일은 블랙리스트 등록되며 관리자가 해제 하기전 까지 추방된 메일로는 회원가입이 불가합니다.</p>
    <hr>
    <img alt="관리자알림" height="500" src="https://github.com/user-attachments/assets/1dac9933-655d-4e9a-b137-894fde26246d" width="800"/>
    <p> - 문의사항 등록시 관리자에게 문의사항 알림이 전송 됩니다.</p>
    <hr>
    <h3> ■ 게시글 관리</h3>
    <img alt="게시글관리" height="500" src="https://github.com/user-attachments/assets/1707b55e-1cab-4ef3-905f-b1db5b1ea2fd" width="800"/>
    <p> - 게시글을 모두 조회할수 있으며, 해당 게시글의 작성된 댓글을 모두 볼수있으며 댓글과 게시글의 대해 삭제 가능합니다.</p>
    <hr>
    <h3> ■ 레시피 관리</h3>
    <h4>레시피 등록</h4>
    ...
    <p> - 관리자는 레시피의 대해서 수정이 가능하며, 조리순서, 재료등을 추가 가능합니다.</p>
    <hr>
    <h3> ■ 공지사항 관리</h3>
    <p> - 공지사항의 대해서 수정, 삭제, 등록이 가능합니다(이전과 동작방식은 동일하여 참고 영상 생략)</p>
    <hr>
    <h3> ■ 문의사항 답변 </h3>
    <img alt="문의 사항답변" height="500" src="https://github.com/user-attachments/assets/1ea84162-3875-42d4-a0f5-7157a1ba6a0c" width="800"/>
    <p> - 관리자는 문의사항의 대해서 답변이 가능합니다. 문의사항 답변 등록시 사용자에게 알림이가며, 이메일 받기 체크시 이메일로도 답변 작성 알림이 전송됩니다.</p>
    <hr>
    <h3> ■ 블랙리스트 관리 </h3>
    <p> - 관리자가 추방시 블랙리스트의 추방한 이메일의 대해서 등록이되며, 해당 이메일의 대해 차단해제 여부를 선택합니다.(해제 기능은 삭제와 동일하여 사진 생략)</p>
  </ul>
</details>
...
<details>
  <summary>문의 하기</summary>
    ...
    <p> - 문의사항에 대해서 질문 등록이 가능합니다. 이메일 알림 체크시 해당 이메일로 답변 등록시 알림전송</p>
    <br>
    <h4> 문의 사항 답변 등록시 </h4>
    <img alt="문의 답변 등록시" height="500" src="https://github.com/user-attachments/assets/c8a7d18b-2418-4b13-89d2-98e0ff3ee124" width="800"/>
    <p> - 관리자가 답변의 대해 등록이 되었을때 답변 작성 알림이 전송되며, 이메일 알림 체크시 이메일로 답변 알림 전송됩니다.</p>
    <hr>
</details>
...
<details>
  <summary> 마이페이지 </summary>
    ...
    <p> - 마이페이지 최초 접근시 비밀번호 검증을 통해 마이페이지 접근가능.</p>
    <p> - 비밀번호 검증 성공시 20분간 재접근이 가능한 쿠키 발급(소셜로그인 사용자는 비밀번호 검증을 하지 않습니다.)</p>
    <hr>
    <h3>닉네임 변경</h3>
    <img alt="닉네임변경" height="500" src="https://github.com/user-attachments/assets/47f38d1a-cd21-4997-8bf9-ecf31ca8a9f2" width="800"/>
    <p> - 일반 로그인 , 소셜로그인 사용자는 닉네임 변경이 가능합니다.</p>
    <hr>
    <h3>이메일 변경</h3>
    ...
    <p> - 작성한 게시글을 볼수있으며 수정 삭제 가능합니다.</p>
    <h4> ※ 좋아요/즐겨찾기 내역</h4>
    <p> - 게시글, 레시피의 좋아요 즐겨찾기 내역을 수정, 삭제, 조회가능합니다.</p>
    <div> ※ 게시글 좋아요</div>
    ...
    <p> - 일반 로그인 사용자는 소셜로그인가 동일 동작, 회원탈퇴시 사용자와 관련된 데이터 모두 삭제됩니다.</p>
    <hr>
</details>

[//]: # (요리 게시글)
<details>
  <summary>요리 후기글</summary>
    <h3>게시글 등록</h3>
    <h4> ※ 레시피에서 게시글 등록</h4>
...
<pre>
<a href="https://github.com/Teeeeeeeam/Recipe-FE/tree/main/src">📦src</a>
 ┣ <a href="https://github.com/Teeeeeeeam/Recipe-FE/tree/main/src/api">📂api</a>
 ┃ ┣ 📜admin-apis.ts
 ┃ ┣ 📜auth-apis.ts
 ┃ ┣ 📜index.ts
 ┃ ┣ 📜login-user-apis.ts
 ...
 ┃ ┣ 📜question-apis.ts
 ┃ ┗ 📜recipe-apis.ts
 ┣ <a href="https://github.com/Teeeeeeeam/Recipe-FE/tree/main/src/app">📂app</a>
 ┃ ┣ 📂[...404]
 ┃ ┃ ┗ 📜page.tsx
 ┃ ┣ 📂admin
 ┃ ┃ ┣ 📂black-list
 ...
 ┃ ┃ ┃ ┣ 📜page.tsx
 ┃ ┃ ┃ ┣ 📜posting-content.tsx
 ┃ ┃ ┃ ┣ 📜posting-image-uploader.tsx
 ┃ ┃ ┃ ┣ 📜posting-password.tsx
 ┃ ┃ ┃ ┗ 📜posting-select.tsx
 ┃ ┣ 📂my-page
 ┃ ┃ ┣ 📂success
 ┃ ┃ ┃ ┣ 📂answer
 ┃ ┃ ┃ ┃ ┣ 📂[id]
 ┃ ┃ ┃ ┃ ┃ ┣ 📜answer-detail-content.tsx
 ┃ ┃ ┃ ┃ ┃ ┣ 📜answer-detail-head-subject.tsx
 ┃ ┃ ┃ ┃ ┃ ┗ 📜page.tsx
 ┃ ┃ ┃ ┃ ┗ 📜page.tsx
 ┃ ┃ ┃ ┣ 📂user-info
 ┃ ┃ ┃ ┃ ┣ 📜form-input-for-update.tsx
 ┃ ┃ ┃ ┃ ┗ 📜page.tsx
 ┃ ┃ ┃ ┣ 📂view-my-bookmark
 ┃ ┃ ┃ ┃ ┗ 📜page.tsx
 ┃ ┃ ┃ ┣ 📂view-my-posting
 ...
 ┃ ┣ 📜layout.tsx
 ┃ ┗ 📜page.tsx
 ┣ <a href="https://github.com/Teeeeeeeam/Recipe-FE/tree/main/src/components">📂components</a>
 ┃ ┣ 📂common
 ┃ ┃ ┣ 📜admin-button.tsx
 ┃ ┃ ┣ 📜admin-input.tsx
 ┃ ┃ ┣ 📜auth-button.tsx
 ...
 ┃ ┃ ┣ 📂infinite-paging
 ┃ ┃ ┃ ┣ 📂input
 ┃ ┃ ┃ ┃ ┣ 📜input-delete-button.tsx
 ┃ ┃ ┃ ┃ ┣ 📜input-table-body-common.tsx
 ┃ ┃ ┃ ┃ ┣ 📜input-table-body-no-data.tsx
 ┃ ┃ ┃ ┃ ┣ 📜input-table-body.tsx
 ┃ ┃ ┃ ┃ ┣ 📜input-table-button.tsx
 ┃ ┃ ┃ ┃ ┗ 📜input-table-header.tsx
 ┃ ┃ ┃ ┗ 📂sequence
 ┃ ┃ ┃ ┃ ┣ 📜table-body-common.tsx
 ┃ ┃ ┃ ┃ ┣ 📜table-body-no-data.tsx
 ┃ ┃ ┃ ┃ ┣ 📜table-body.tsx
 ┃ ┃ ┃ ┃ ┣ 📜table-button.tsx
 ┃ ┃ ┃ ┃ ┗ 📜table-header.tsx
 ┃ ┃ ┗ 📜notify-recent.tsx
 ┃ ┣ 📜footer.tsx
 ┃ ┣ 📜header-responsive.tsx
 ┃ ┗ 📜index.tsx
 ┣ <a href="https://github.com/Teeeeeeeam/Recipe-FE/tree/main/src/hooks">📂hooks</a>
 ┃ ┣ 📜use-category-selection.ts
 ┃ ┣ 📜use-check-box.ts
 ┃ ┗ 📜use-infinite-scroll.ts
 ┣ <a href="https://github.com/Teeeeeeeam/Recipe-FE/tree/main/src/lib">📂lib</a>
 ┃ ┣ 📜email-authentication.ts
 ┃ ┣ 📜index.ts
 ┃ ┣ 📜local-storage.ts
 ┃ ┣ 📜regexp.ts
 ┃ ┗ 📜validation-check.ts
 ┣ <a href="https://github.com/Teeeeeeeam/Recipe-FE/tree/main/src/store">📂store</a>
 ┃ ┣ 📜index.ts
 ┃ ┣ 📜mod-userRecipe-slice.ts
 ┃ ┣ 📜provider.tsx
 ┃ ┣ 📜search-id-slice.ts
 ┃ ┣ 📜search-password-slice.ts
 ┃ ┣ 📜search-recipe-slice.ts
 ┃ ┣ 📜user-info-slice.ts
 ┃ ┣ 📜visited-slice.ts
 ┃ ┗ 📜write-userRecipe-slice.ts
 ┗ <a href="https://github.com/Teeeeeeeam/Recipe-FE/tree/main/src/types">📂types</a>
 ┃ ┣ 📂login-user-apis-type
 ┃ ┃ ┗ 📜index.ts
 ┃ ┣ 📂question-api-type
 ┃ ┃ ┗ 📜index.ts
 ┃ ┣ 📂recipe-apis-type
